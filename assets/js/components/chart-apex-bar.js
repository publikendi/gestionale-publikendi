var colors = ["#39afd1"],
  ...
  colors =
    ...
    ["#5b69bc", "#10c469", "#fa5c7c", "#35b8e0", "#39afd1"]),
  ...
  colors =
    ...
    ["#f9c851", "#39afd1", "#35b8e0", "#e3eaef", "#5b69bc"]),
  ...
  options = {
    ...
    dataLabels: {
      dataLabels: {
        formatter: function (o, e) {
          return (
            e.w.config.series[e.seriesIndex].data[e.dataPointIndex].goals, o
          );
        },
      },
    },
