const salesforceAccounts = require("../services/salesforceAccounts");
...
exports.getAccounts = async (req, res) => {
  try {
    ...
    const records = await salesforceAccounts.fetchAccount({
    ...
    console.error('[accountController.getAccounts] failed', err.message);
    ...
    return res.status(statusCode).json({ 
      error: 'Errore durante il recupero degli account' 
    });
  }
